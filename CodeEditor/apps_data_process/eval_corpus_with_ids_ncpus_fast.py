...
def main():
    import argparse
    args_parser = argparse.ArgumentParser()
    args_parser.add_argument("--inp_path", type=str, default="code_gens_0_200.json")
    args_parser.add_argument("--save_path", type=str, default="eval_corpus_ncpus_fast.json")
